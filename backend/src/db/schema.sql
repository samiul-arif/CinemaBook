-- CinemaSeat Complete Consolidated PostgreSQL Schema
-- Includes initial tables, ticket generation fields, HMAC signatures, and gate check-in tracking.
...
-- 4. Seats Table (One row per physical seat per showtime - targeted for atomic locking)
...
-- 7. Payment Events Table (Idempotent webhook payload log)
